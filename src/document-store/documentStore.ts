...
export const initializeDocumentStore = async (documentStore: IDocumentStore) => {
  ...
  const countries = [
    new Country("AU", "Australia", true, "zipCode", true, "state", [
    ...
    new Country("BM", "Bahamas"),
    new Country("CA", "Canada", true, "zipCode", true, "province", [
    ...
    new Country("JM", "Jamaica", true, "postalCode", false),
    new Country("PL", "Poland", true, "postalCode", true),
    new Country("UK", "United Kingdom", true, "postalCode", true),
    new Country("US", "United States of America", true, "zipCode", true, "state", [
